...
public class Destroyer extends BattleShip {
	...
	public Destroyer(String id, IMapPlayer map, Direction dir, Coordinates ref) throws ShipAlreadyExistsException, ShipOutOfMapException, ShipsOverlappingException {
