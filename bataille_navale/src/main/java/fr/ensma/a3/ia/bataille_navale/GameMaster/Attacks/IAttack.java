...
public interface IAttack {
	public int attack(IUnit bateau, IMap targetMap, Coordinates coos) throws ShipIsDisabledException, AttackOutOfMapException, ShipCannotAttackException, ShipCannotFlareException;
}
